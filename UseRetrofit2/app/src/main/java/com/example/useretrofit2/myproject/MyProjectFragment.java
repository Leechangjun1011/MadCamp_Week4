...
public class MyProjectFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        show_time = (TextView) root.findViewById(R.id.show_play_time);
        sb = (SeekBar) root.findViewById(R.id.myproject_seekBar);
        ...
        mediaPlayer = MediaPlayer.create(getContext(), R.raw.meteor);
        ...
        play = (ImageButton) root.findViewById(R.id.myproject_play);
        pause = (ImageButton) root.findViewById(R.id.myproject_pause);
        ...
        listView = (ListView) root.findViewById(R.id.lv_myproject_commit);
